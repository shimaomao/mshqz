...
* @Last Modified time: 2016-07-29 15:37:49
*/
function init(){
    require(['./jquery'],function($){
        ...
        function initUI(){
            ...
            $('.download-btn').on('touchend', function(event) {
                if(isAndroid){
                    window.location.href = 'http://lnk0.com/t40Qts?kwid={keywordid}&creative={creative}';
                }else if(isiOS){
                    window.location.href = 'http://lnk0.com/Fxtgg8?kwid={keywordid}&creative={creative}';
                   // alert('敬请期待！')
                }
                return false;
            });
            ...
            $('#android').on('touchend', function(event) {
                if(isAndroid){
                    window.location.href = 'http://lnk0.com/t40Qts?kwid={keywordid}&creative={creative}';
                }else if(isiOS){
                    window.location.href = 'http://lnk0.com/Fxtgg8?kwid={keywordid}&creative={creative}';
            ...
            var videostr = '';
            var _videoTimeId = 0;
            $("#guoman-play,.box2 .play").on('touchend',function(event) {
